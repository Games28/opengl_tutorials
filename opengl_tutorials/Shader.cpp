...
{
	return uniformSpecularIntesity;
}
...
{
	glUniformMatrix4fv(uniformDrectionalLightTransform, 1, GL_FALSE, glm::value_ptr(*ltransform));
}
...
void Shader::CompileProgram()
{
	...
	uniformDrectionalLightTransform = glGetUniformLocation(shaderID, "directionalLightTransform");
